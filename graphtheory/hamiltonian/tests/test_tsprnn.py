...
class TestTSP(unittest.TestCase):
    ...
    def test_exceptions(self):
        self.assertRaises(ValueError, RepeatedNearestNeighborTSPWithEdges, Graph(5, True))
        self.assertRaises(ValueError, RepeatedNearestNeighborTSPWithGraph, Graph(5, True))
