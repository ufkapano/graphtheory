...
class TreeWeightedDominatingSet1:
    ...
    This is a generalization of the BorieDominatingSet class.
    A simple approach but O(n) time is not obtained.
    """
...
class TreeWeightedDominatingSet2:
    """Find a minimum weight dominating set for trees, O(n) time.
    ...
    def _compose(self, arg1, arg2):
        ...
        pair1 = a1_pair
        pair2 = min(arg2, key=lambda pair: pair[0])
...
TreeWeightedDominatingSet = TreeWeightedDominatingSet2
